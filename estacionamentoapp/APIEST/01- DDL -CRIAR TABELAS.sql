...
valor_preco numeric(5,2) not null,
tempo_preco varchar(11) not null
);

create table preco_hp (
id_hp integer,
id_preco integer,
primary key(id_hp,id_preco),
...
alter table preco_hp add foreign key(id_hp) references historico_pagamento (id_hp);
